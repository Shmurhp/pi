	...
	**/
	...
	function iatExtension(options)
	{
		...
		*/
		...
		var iBlock2Mini;
		for (iBlock2Mini = 1; iBlock2Mini <= 1; iBlock2Mini++)
		{
		...
		var iBlock1Mini;
		for (iBlock1Mini = 1; iBlock1Mini <= 1; iBlock1Mini++)
		{
			trialSequence.push(getMiniMixer2(
			{nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
		...
		var iBlock3Mini;
		for (iBlock3Mini = 1; iBlock3Mini <= 1; iBlock3Mini++)
		{
		...
		{//Fourth block is another combined block.
			...
			nTrialsInMini = blockParamsCombined.nTrials/blockParamsCombined.nMiniBlocks;
			var iBlock4Mini;
			for (iBlock4Mini = 1; iBlock4Mini <= 1; iBlock4Mini++)
			{
				trialSequence.push(getMiniMixer4({
				nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
				rightTrial1 : rightAttTrial, leftTrial1 : leftAttTrial,
		...
		var iBlock5Mini;
		for (iBlock5Mini = 1; iBlock5Mini <= 1; iBlock5Mini++)
		{
			trialSequence.push(getMiniMixer2({
			nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
			rightTrial : rightCatTrial, leftTrial : leftCatTrial, blockNum : iBlock,
		...
		nTrialsInMini = blockParamsCombined.nTrials/blockParamsCombined.nMiniBlocks;
		var iBlock6Mini;
		for (iBlock6Mini = 1; iBlock6Mini <= 1; iBlock6Mini++)
		{
			trialSequence.push(getMiniMixer4({
			nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
			rightTrial1 : rightAttTrial, leftTrial1 : leftAttTrial,
		...
		{//Fourth block is another combined block.
			...
			nTrialsInMini = blockParamsCombined.nTrials/blockParamsCombined.nMiniBlocks;
			var iBlock7Mini;
			for (iBlock7Mini = 1; iBlock7Mini <= 1; iBlock7Mini++)
			{
				trialSequence.push(getMiniMixer4({
				nTrialsInMini : nTrialsInMini, currentCond : blockCondition,
				rightTrial1 : rightAttTrial, leftTrial1 : leftAttTrial,
